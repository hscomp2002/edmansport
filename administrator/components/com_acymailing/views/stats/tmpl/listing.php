		...
		<thead>
			<tr>
				...
				<th class="title titledate">
					<?php echo JHTML::_('grid.sort',   JText::_( 'SEND_DATE' ), 'a.senddate', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<th class="title">
					<?php echo JHTML::_('grid.sort', JText::_( 'JOOMEXT_SUBJECT'), 'b.subject', $this->pageInfo->filter->order->dir,$this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<th class="title">
					<?php echo JHTML::_('grid.sort',   JText::_( 'OPEN' ), 'a.openunique', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<?php if(acymailing_level(1)){?>
				<th class="title">
					<?php echo JHTML::_('grid.sort',   JText::_( 'CLICKED_LINK' ), 'a.clickunique', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<?php } ?>
				<th class="title">
						<?php echo JHTML::_('grid.sort',   JText::_( 'UNSUBSCRIBE' ), 'a.unsub', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
					</th>
				<?php if(acymailing_level(1)){?>
				...
				<?php } ?>
				<th class="title titletoggle">
					<?php echo JHTML::_('grid.sort',   JText::_( 'SENT_HTML' ), 'a.senthtml', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<th class="title titletoggle">
