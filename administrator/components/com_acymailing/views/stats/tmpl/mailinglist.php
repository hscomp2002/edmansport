...
?><div id="acy_content" >
	...
	<div class="acychart mailingListChart" width="350px" height="350px">
		...
		<textarea cols="35" rows="10" id="exporteddata_sent" style="display:none;position:absolute;margin-top:-160px;z-index:2;" class="donotprint"><?php echo $detailSent; ?></textarea>
	</div>
	<div class="acychart mailingListChart" width="350px" height="350px">
		...
		<textarea cols="35" rows="10" id="exporteddata_open" style="display:none;position:absolute;margin-top:-160px;z-index:2;" class="donotprint"><?php echo $detailOpen; ?></textarea>
	</div>
	...
	<div class="acychart mailingListChart" width="350px" height="350px">
		...
		<textarea cols="35" rows="10" id="exporteddata_unsub" style="display:none;position:absolute;margin-top:-160px;z-index:2;" class="donotprint"><?php echo $detailUnsub; ?></textarea>
	</div>
</div>
