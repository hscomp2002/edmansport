...
<fieldset class="adminform" id="filteredUsers">
	...
	<div id="acyFilteredUsers" >
		<table class="adminlist table table-striped table-hover" cellpadding="1">
			<thead>
				<tr>
					<th class="title titlenum"><?php echo JText::_( 'ID' ); ?></th>
			...
			<tbody>
				...
				foreach($this->filteredUsers['users'] as $user){?>
					<tr class="row<?php echo $k; ?>">
						<td align="center"><?php echo $user->subid; ?></td>
						<td align="center"><?php echo $user->name; ?></td>
						<td align="center"><?php echo '<a href="'.acymailing_completeLink('subscriber&task=edit&subid='.$user->subid).'" target="_blank">'.$user->email.'</a>'; ?></td>
					</tr>
				<?php
					$k = 1-$k;
				} ?>
