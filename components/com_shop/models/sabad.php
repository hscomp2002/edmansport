...
class ShopModelSabad  extends JModelItem { 

	
	
	protected $context = 'com_shop.sabad';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Sabad', 'Table');
