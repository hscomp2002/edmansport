...
class ShopModelKala  extends JModelItem { 

	
	
	protected $context = 'com_shop.kala';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Kala', 'Table');
