...
class ShopModelFactor  extends JModelItem { 

	
	
	protected $context = 'com_shop.factor';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Factor', 'Table');
